...
switch_window = Window(
    Const('Отправляем вам <b>краткую</b> инструкцию👆🏻\n\n'
          'Установка беспроводного выключателя занимает <i>15</i> минут.\n'
          'А беспроводной умный свет можно добавить как до, так и после ремонта за <i>1</i> день.\n'
          'Устройства работают по радиоканалу, без интернета на расстоянии до <i>250</i> кв.м.\n\n'
          ...
          'Мы также можем подобрать вам установщика в любом городе России и даем гарантию <i>3</i> года 🇷🇺'),
    StaticMedia(
...
async def connect_with_manager(callback: CallbackQuery, button: Button, dialog_manager: DialogManager):
    ...
    await dialog_manager.event.callback.answer(text='Подпишитесь на наш телеграм-канал <a href="https://t.me/hitepro">HiTE-PRO</a>,\n'
...
discount_window = Window(
    Const('💙 Дарим скидку <b>10%</b> на любые модели беспроводных выключателей и устройства для умного дома!\n'
